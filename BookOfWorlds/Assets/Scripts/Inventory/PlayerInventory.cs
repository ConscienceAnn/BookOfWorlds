...
public class PlayerInventory : MonoBehaviour, IPlayerInventory
{
    ...
    public bool TryAdd(string resourceName, int amount = 1)
    {
        ...
        if (slot == null)
        {
            Debug.LogError($"[PlayerInventory] TryAdd: ÒÎÓÚ {resourceName} Õ≈ Õ¿…ƒ≈Õ!");
            return false;
        }
    ...
    public bool TrySpend(string resourceName, int amount)
    {
        ...
        if (slot == null)
        {
            Debug.LogError($"[PlayerInventory] TrySpend: ÒÎÓÚ {resourceName} Õ≈ Õ¿…ƒ≈Õ!");
            return false;
        }
    ...
    private ResourceSlot GetSlot(string resourceName)
    {
        ...
        Debug.LogError($"[PlayerInventory] GetSlot: ÒÎÓÚ {resourceName} Õ≈ Õ¿…ƒ≈Õ!");
        return null;
    }
}